          ...
          <div className="layer reveal">
            ...
            <form className="holo-fields" onSubmit={handleSubmit} noValidate>
              ...
              <button type="submit" className="holo-submit" disabled={loading}>
                {loading ? <><i className="fa-solid fa-spinner fa-spin"></i> Creating account…</> : <><span>Register as {role === 'recruiter' ? 'Company' : 'Job Seeker'}</span><i className="fa-solid fa-arrow-right-long"></i></>}
              </button>
              <div className="holo-divider">or</div>
              <button type="button" className="google-btn" onClick={() => loginWithGoogle(role)}>
                ...
                Sign up as {role === 'recruiter' ? 'Company' : 'Job Seeker'} with Google
              </button>
