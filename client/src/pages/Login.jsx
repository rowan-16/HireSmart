          ...
          <div className="layer reveal">
            ...
            <form className="holo-fields" onSubmit={handleSubmit} noValidate>
              ...
              <button type="submit" className="holo-submit" disabled={loading}>
                {loading ? <><i className="fa-solid fa-spinner fa-spin"></i> Signing in…</> : <><span>Sign in as {role === 'recruiter' ? 'Company' : 'Job Seeker'}</span><i className="fa-solid fa-arrow-right-long"></i></>}
              </button>
              ...
              <button type="button" className="google-btn" onClick={() => loginWithGoogle(role)}>
                ...
                Sign in as {role === 'recruiter' ? 'Company' : 'Job Seeker'} with Google
              </button>
